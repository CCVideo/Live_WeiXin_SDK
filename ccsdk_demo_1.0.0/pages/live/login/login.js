    ...
    login: function () {
        ...
        cc.live.init({
            ...
            success: function (data) {
                ...
                var chatLogJson = JSON.stringify(self.data.chatLog);
                var answerLogJson = JSON.stringify(self.data.answerLog);
                var questionLogJson = JSON.stringify(self.data.questionLog);
                var pageDataJson = JSON.stringify(self.data.pageData);
                var str = 'isPublishing='
                    + encodeURIComponent(self.data.isPublishing)
                    + '&roomTitle=' + encodeURIComponent(self.data.roomTitle)
                    ...
                    + '&pageData=' + encodeURIComponent(pageDataJson)
                    + '&chatLog=' + encodeURIComponent(chatLogJson)
                    + '&answerLog=' + encodeURIComponent(answerLogJson)
                    + '&questionLog=' + encodeURIComponent(questionLogJson);
                wx.navigateTo({
